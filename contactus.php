...
<!-- Mirrored from validthemes.online/themeforest/techa/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 20 Jul 2022 12:25:38 GMT -->
<head>
<?php
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2">
                                        <div class="content">
                                            <h2 data-animation="animated slideInRight">Contact us <strong>NOW</strong></h2>
    ...
    <div class="contact-area overflow-hidden default-padding bg-gray">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-10 contact-form-box">
                    <div class="content">
                        <div class="heading">
                            <h2>CONTACT US NOW?</h2>
                            <p>WE WOULD GET IN TOUCH WITH YOU WITHIN 24 hours.</p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group comments">
                                        <textarea class="form-control" id="comments" name="comments" placeholder="What do you think about us."></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="button" name="submit" id="submit" onclick ="contactus()">
                                        Contact us
                                    </button>
                                </div>
                            </div>
